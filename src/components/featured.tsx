...
const Featured = () => {
  ...
  return (
    <div className="w-full bg-neutral-900 pb-28 pt-0 flex flex-col justify-center items-center">
      <h1 className="text-4xl font-light underline underline-offset-8 uppercase text-white pt-10 pb-5"> Featured Section </h1>
      <h1 className="text-6xl font-extrabold text-white pb-10 mx-auto text-center">Learn from the best</h1>
